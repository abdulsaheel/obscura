 ...
 * @notice On-chain registry of verified PrivateVault instances. A vault can be
 *         indexed only if its runtime codehash matches the canonical codehash,
 *         which lets distributed indexers discover vaults that are provably
 *         identical to the audited implementation.
 */
