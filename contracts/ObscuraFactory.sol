...
/**
 * @title ObscuraFactory
 * @notice Deploys PrivateVault instances with deterministic (CREATE2) bytecode
 *         so that every vault shares the same canonical codehash and can be
 *         verified + indexed by the IndexerRegistry.
 */
